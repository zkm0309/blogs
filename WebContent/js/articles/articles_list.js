...
$(function() {
	...
	_table = $table.dataTable($.extend(true,{},CONSTANT.DATA_TABLES.DEFAULT_OPTION, {
        ajax : function(data, callback, settings) {//ajax配置为function,手动调用异步查询
            ...
            $.ajax({
                    type: "POST",
                    url: $("#ctx").val()+"/articles/findAll.do",
                    cache : false,  //禁用缓存
                    dataType: "json",
		...
		columns: [
           ...
           {data: "keywords",render : CONSTANT.DATA_TABLES.RENDER.ELLIPSIS},
           {data: "abstracts",render : CONSTANT.DATA_TABLES.RENDER.ELLIPSIS},
           {data: "assortmentname",render : CONSTANT.DATA_TABLES.RENDER.ELLIPSIS},
           {data: "authors",render : CONSTANT.DATA_TABLES.RENDER.ELLIPSIS},
           {data: "auditstatusname",render : CONSTANT.DATA_TABLES.RENDER.ELLIPSIS},
        ...
        createdRow: function ( row, data, index ) {
            ...
            var $btnEdit = $('<a title="编辑" href="javascript:void(0);" onclick="admin_edit(\'角色编辑\',\'articles_add.jsp\',\''+data.id+'\',\'800\',\'500\')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>');
