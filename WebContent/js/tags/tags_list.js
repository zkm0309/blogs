...
$(function() {
	...
	_table = $table.dataTable($.extend(true,{},CONSTANT.DATA_TABLES.DEFAULT_OPTION, {
		...
		columns: [
            ...
            {data: "tagname",render : CONSTANT.DATA_TABLES.RENDER.ELLIPSIS},
            {data: "code",render : CONSTANT.DATA_TABLES.RENDER.ELLIPSIS},
            {data: "tagurl",render : CONSTANT.DATA_TABLES.RENDER.ELLIPSIS},
        ...
        createdRow: function ( row, data, index ) {
            ...
            var $btnEdit = $('<a title="编辑" href="javascript:void(0);" onclick="admin_edit(\'角色编辑\',\'tags_add.jsp\',\''+data.id+'\',\'800\',\'500\')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>');
