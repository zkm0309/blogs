  ...
  <div class="col-sm-9 col-md-9 mt-20">
	...
	<ul class="index_arc">
		<li class="index_arc_item">
			<a href="#" class="pic">
				<img class="lazyload" data-original="${ctx}/images/timg_new.jpg" alt="应该选" />
			</a>
        ...
        <li class="index_arc_item">
		 ...
		 <li class="index_arc_item">
	            <a href="/article/4" class="pic">
	                <img class="lazyload" data-original="${ctx}/images/timg_new.jpg" alt="centos 6.5 nginx安装及配置" >
	            </a>
