			...
			<article class="page-container">
				<form class="form form-horizontal" id="form-admin-add">
					...
					<div class="row cl">
						...
						<div class="formControls col-xs-6 col-sm-6">
							<input type="text" class="input-text" placeholder="上级分类" name="pName" readonly="readonly">
					...
					<div class="row cl">
						<label class="form-label col-xs-4 col-sm-2">
							CODE：</label>
						<div class="formControls col-xs-6 col-sm-6">
							<input type="text" class="input-text" placeholder="CODE" name="code">
						</div>
					</div>
					<div class="row cl">
						<label class="form-label col-xs-4 col-sm-2">
...
<!-- zkm 2018-9-4 js 公共引用 -->
<%@include file="/include/javascript.jsp"%>
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="${ctx}/js/assortment/assortment_list.js?${random}"></script>
</body>
</html>
