...
<div class="page-container">
	<div class="text-c">
			标签标题：
			<input type="text" class="input-text" style="width:250px;" placeholder="标签标题" name="name">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l">
				...
				<a href="javascript:;" onclick="admin_add('添加标签','tags_add.jsp','800','500')" class="btn btn-primary radius">
...
<script type="text/javascript" src="${ctx}/js/tags/tags_list.js?${random}"></script>
