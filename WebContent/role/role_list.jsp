...
<div class="page-container">
	<div class="text-c">
			角色名称：
			<input type="text" class="input-text" style="width:250px;" placeholder="输入角色名称" name="name">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l">
				...
				<a href="javascript:;" onclick="admin_add('添加角色','role_add.jsp','800','500')" class="btn btn-primary radius">
...
<script type="text/javascript" src="${ctx}/js/role/role_list.js?${random}"></script>
